...
public:
	...
	boost::circular_buffer< Frame*, Eigen::aligned_allocator<Frame*> > keyframesAll;
	...
	boost::circular_buffer< KFConstraintStruct*, Eigen::aligned_allocator<KFConstraintStruct*> > edgesAll;
	...
	boost::circular_buffer<FramePoseStruct*, Eigen::aligned_allocator<FramePoseStruct*> > allFramePoses;
