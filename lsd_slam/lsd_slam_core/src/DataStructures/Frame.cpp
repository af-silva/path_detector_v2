...
Frame::Frame(int id, int real_id, int width, int height, const Eigen::Matrix3f& K, double timestamp, const unsigned char* image,  const unsigned char* rgbImage)
 {
...
void Frame::releaseRGBImage(int level)
{
